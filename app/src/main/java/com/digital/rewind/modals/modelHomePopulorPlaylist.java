...
public class modelHomePopulorPlaylist {

        String playlistimage,playlistName,playlistCreator;
        List<String> songs;

    public modelHomePopulorPlaylist() {
    }

    public modelHomePopulorPlaylist(String playlistimage, String playlistName, String playlistCreator, List<String> songs) {
