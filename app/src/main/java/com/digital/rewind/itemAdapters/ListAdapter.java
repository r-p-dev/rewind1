...
public class ListAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.row_item_songs, null);
    ...
    private static class ViewHolder{
        ...
        ViewHolder(View view){
            songName = view.findViewById(R.id.songs_song_title);
            thumbnail = view.findViewById(R.id.songs_song_image);
            artistName = view.findViewById(R.id.songs_song_art_name);
            songDuration = view.findViewById(R.id.songs_song_length);
